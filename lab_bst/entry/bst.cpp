...
{
    std::vector<std::pair<std::string, int>> outList = file_to_listPair("../data/sonnets1.txt");
...
{
    std::vector<std::pair<std::string, int>> inList = file_to_listPair("../data/file4.txt");
